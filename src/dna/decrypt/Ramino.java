...
public class Ramino {
        ...
        public String getValue(String dnacipher) {
            String b[][] = new String[][]{{"GCA", "TGT", "GAT", "GAA", "GGA", "CAT", "ATA", "AAA", "TTA", "ATG", "AAT", "CCA", "CAA", "AGA", "AGT", "ACA", "GTA", "TGG", "TAT", "TAA", "TTT"},
...
//System.out.println(slast);
                ...
                System.out.println("amino to cipher " + output);
            } catch (Exception ex) {
